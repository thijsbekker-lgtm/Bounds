...
(function(){
  const paths = {
    ...
    range:'<circle cx="6.5" cy="17.5" r="1.8"/><path d="M8.5 16.5c2.7-4.7 6.2-7.8 11-9.5"/><path d="M15.5 7h4v4"/>',
    ...
    club:'<path d="M6 5l12 14"/><path d="M18 5 6 19"/><path d="M5 4h3"/><path d="M16 20h3"/>',
